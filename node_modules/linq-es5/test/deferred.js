...
describe('Deferred Execution -', function () {
    ...
    it('Cast()', function () {
        ...
        var iterable = linq_1.default([]);
        chai_1.assert.equal(iterable.Cast(), iterable);
    });
    // ChunkBy
    it('ChunkBy()', function () {
        var iterable = linq_1.default(data_1.phrase).ChunkBy(function (o) { return o.key; }, function (o) { return o.value; });
    ...
    it('ChunkBy() - Index', function () {
        var iterable = linq_1.default(data_1.phrase).ChunkBy(function (o, i) { return Math.max(3, i); }, function (o) { return o.value; });
        var iterator = iterable[Symbol.iterator]();
        var arr = iterator.next().value;
    ...
    it('ChunkBy() - Zero', function () {
        var iterable = linq_1.default([{ key: 0, value: "0" },
            { key: 0, value: "1" },
            { key: 0, value: "2" },
            { key: 0, value: "3" },
            { key: 0, value: "4" },
            ...
            { key: 0, value: "7" },
            { key: 0, value: "!" }])
            .ChunkBy(function (k) { return k.key; }, function (o) { return o.value; });
        var iterator = iterable[Symbol.iterator]();
        var arr = iterator.next().value;
    ...
    it('ChunkBy() - Empty', function () {
        var iterable = linq_1.default([]).ChunkBy(function (e) { return e; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.isTrue(iterator.next().done);
    });
    // Concat
    ...
    it('Concat() - QJesus', function () {
        var xs = [{ x: 'x', b: true }, { x: 'y', b: false }, { x: 'z', b: true }];
        var iterable = linq_1.default(xs).Where(function (f) { return f.b; }).Concat(linq_1.default(xs).Where(function (f) { return !f.b; }).ToArray());
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal('x', iterator.next().value.x);
        chai_1.assert.equal('z', iterator.next().value.x);
        chai_1.assert.equal('y', iterator.next().value.x);
        chai_1.assert.isTrue(iterator.next().done);
    });
    // Select
    it('Select()', function () {
        var array = linq_1.default(data_1.jsn).Select(function (a) { return a.name; }).ToArray();
    ...
    it('Select() - With index', function () {
        var array = linq_1.default(data_1.jsn).Select(function (a, b) { return b; }).ToArray();
        chai_1.assert.equal(array.length, 4);
    ...
    it('Distinct() - Number', function () {
        var iterable = linq_1.default([0, 0, 1, 3, 5, 6, 5, 7, 8, 8]).Distinct();
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(0, iterator.next().value);
        chai_1.assert.equal(1, iterator.next().value);
        chai_1.assert.equal(3, iterator.next().value);
    ...
    it('Distinct() - String', function () {
        ...
        var iterable = linq_1.default(test).Distinct();
        var iterator = iterable[Symbol.iterator]();
    ...
    it('Distinct() - Key', function () {
        ...
        var iterable = linq_1.default(test).Distinct(function (o) { return o.id; });
        var iterator = iterable[Symbol.iterator]();
    ...
    // Where
    it('Where()', function () {
        var iterable = linq_1.default(data_1.simpleArray).Where(function (a) { return a % 2 == 1; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(1, iterator.next().value);
        chai_1.assert.equal(3, iterator.next().value);
        chai_1.assert.equal(5, iterator.next().value);
    ...
    it('Where() - Index', function () {
        var iterable = linq_1.default(data_1.simpleArray).Where(function (a, i) { return i % 2 == 1; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(2, iterator.next().value);
        chai_1.assert.equal(4, iterator.next().value);
        chai_1.assert.equal(6, iterator.next().value);
    ...
    // Skip
    it('Skip()', function () {
        var iterable = linq_1.default(data_1.simpleArray).Skip(7);
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(8, iterator.next().value);
        chai_1.assert.equal(9, iterator.next().value);
        chai_1.assert.equal(10, iterator.next().value);
    ...
    it('SkipWhile()', function () {
        var iterable = linq_1.default(data_1.simpleArray).SkipWhile(function (a) { return a < 8; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(8, iterator.next().value);
        chai_1.assert.equal(9, iterator.next().value);
        chai_1.assert.equal(10, iterator.next().value);
    ...
    it('SkipWhile() - Index', function () {
        ...
        var iterable = linq_1.default(amounts).SkipWhile(function (amount, index) { return amount > index * 1000; });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('TakeWhile()', function () {
        var iterable = linq_1.default(data_1.simpleArray).TakeWhile(function (a) { return a < 4; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(1, iterator.next().value);
        chai_1.assert.equal(2, iterator.next().value);
        chai_1.assert.equal(3, iterator.next().value);
    ...
    it('Except() - Key', function () {
        var iterable = linq_1.default(data_1.un1).Except(data_1.un2, function (o) { return o.id; });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('Intersect() - Key', function () {
        var iterable = linq_1.default(data_1.un1).Intersect(data_1.un2, function (o) { return o.id; });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('Union() - Keyed', function () {
        var iterable = linq_1.default(data_1.un1).Union(data_1.un2, function (o) { return o.id; });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('Union() with Join()', function () {
        ...
        var bs = [{ b: 1, c: 1 }];
        var bs2 = [{ b: 2, c: 2 }];
        var iterable = linq_1.default(as)
            .Join(bs, function (a) { return a.b; }, function (b) { return b.b; }, function (_, b) { return b; }).Union(bs2);
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(bs[0], iterator.next().value);
        chai_1.assert.equal(bs2[0], iterator.next().value);
        chai_1.assert.isTrue(iterator.next().done);
    });
    // Join
    it('Join()', function () {
        var iterable = linq_1.default(data_1.people).Join(data_1.pets, function (person) { return person; }, function (pet) { return pet.Owner; }, function (person, pet) {
    ...
    it('Join() - Redundant', function () {
        var iterable = linq_1.default(data_1.un1).Join(data_1.jsn, function (e) { return e.id; }, function (u) { return u.id; }, function (e, u) {
        ...
        var iterable = linq_1.default(data_1.people)
            ...
            return {
                ...
                Pets: !petCollection ? null
                    : linq_1.default(petCollection).Select(function (pet) { return pet.Name; })
                        .ToArray()
            };
        });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('GroupJoin() - MSDN', function () {
        var iterable = linq_1.default(data_1.msdn)
            ...
            return {
                Owner: person.Name,
                Pets: linq_1.default(petCollection).Select(function (pet) { return pet.Name; })
                    .ToArray()
            };
        });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('GroupJoin() - QJesus', function () {
        ...
        var join = linq_1.default(yx).GroupJoin(zx, function (a) { return a.id; }, function (b) { return b.id; }, function (a, temp) { return ({ a: a, temp: temp }); })
            .ToArray();
        chai_1.assert.equal(3, join.length);
    });
    // GroupBy
    it('GroupBy()', function () {
        var iterable = linq_1.default(data_1.pets).GroupBy(function (pet) { return pet.Age; });
        var iterator = iterable[Symbol.iterator]();
        var result = iterator.next().value;
    ...
    it('GroupBy() - Selector', function () {
        var iterable = linq_1.default(data_1.pets).GroupBy(function (pet) { return pet.Age; }, function (pet) { return pet; });
        var iterator = iterable[Symbol.iterator]();
        var result = iterator.next().value;
        chai_1.assert.equal(8, result.key);
        chai_1.assert.equal(1, result.length);
    ...
    it('SelectMany()', function () {
        var iterable = linq_1.default(data_1.jsn).SelectMany(function (a) { return a.ids; });
        var iterator = iterable[Symbol.iterator]();
    ...
    it('SelectMany() - Selector', function () {
        var iterable = linq_1.default(data_1.jsn).SelectMany(function (a) { return a.ids; }, function (t, s) { return s; });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(11, iterator.next().value);
        chai_1.assert.equal(21, iterator.next().value);
        chai_1.assert.equal(31, iterator.next().value);
    ...
    it('SelectMany() - Selector QJesus', function () {
        ...
        var method = function (gp, idx) { return linq_1.default(gp).Select(function (o) { return ({
            col: o.col,
            row: o.row,
            idx: idx,
        }); }); };
        var lines = linq_1.default(points).GroupBy(function (p) { return p.row; }).SelectMany(method).ToArray();
        var iterable = linq_1.default(points).GroupBy(function (p) { return p.row; }).SelectMany(function (gp, idx) { return linq_1.default(gp).Select(function (o) { return ({
            col: o.col,
            row: o.row,
            idx: idx,
        }); }); });
        var iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(0, iterator.next().value.idx);
        chai_1.assert.equal(0, iterator.next().value.idx);
        chai_1.assert.equal(0, iterator.next().value.idx);
        chai_1.assert.equal(1, iterator.next().value.idx);
        chai_1.assert.equal(1, iterator.next().value.idx);
        chai_1.assert.equal(1, iterator.next().value.idx);
        chai_1.assert.equal(2, iterator.next().value.idx);
        chai_1.assert.equal(2, iterator.next().value.idx);
        chai_1.assert.equal(2, iterator.next().value.idx);
        chai_1.assert.equal(3, iterator.next().value.idx);
        chai_1.assert.equal(3, iterator.next().value.idx);
        chai_1.assert.equal(3, iterator.next().value.idx);
        chai_1.assert.isTrue(iterator.next().done);
    });
